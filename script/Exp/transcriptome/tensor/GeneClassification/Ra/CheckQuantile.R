...
Threshold <- c(0.2,0.8)
df.q <- data.frame(
  "B__L1_2__Virus" = quantile(data.2[,"B__L1_2__Virus"],Threshold),
  "TNK__L1_2__Virus" = quantile(data.2[,"TNK__L1_2__Virus"],Threshold),
  "Mono__L1_2__Virus" = quantile(data.2[,"Mono__L1_2__Virus"],Threshold),
  "B__L1_2__LPS" = quantile(data.2[,"B__L1_2__LPS"],Threshold),
  "TNK__L1_2__LPS" = quantile(data.2[,"TNK__L1_2__LPS"],Threshold),
  "Mono__L1_2__LPS" = quantile(data.2[,"Mono__L1_2__LPS"],Threshold)
)
