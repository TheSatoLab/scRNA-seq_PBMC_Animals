...
Seurat$BasicClusterID_rev <- factor(Seurat$BasicClusterID,level=rev(levels(Seurat$BasicClusterID)))
...
p <- DotPlot(Seurat,features = features,group.by="BasicClusterID_rev",assay="SCT")
